...
knitr::include_graphics("assets/img/figure_20-01.jpg")
```
...
```{r, out.width=260}
knitr::include_graphics("assets/img/figure_20-02.jpg")
knitr::include_graphics("assets/img/newtmitosis.jpg")
```
...
```{r, out.width=400}
knitr::include_graphics("assets/img/p16-p27mech.png")
```
...
```{r}
knitr::include_graphics("assets/img/RBvsCDKImuts.png")
```
...
- Fosfo-SMAD3 istub koos E2F4/5 (repressiivsed E2F valgud), p107 ja C/EBPbeta valkudega Myc geeni promootoril ja paneb sellelt transkriptsiooni efektiivselt kinni.
