...
background-image: url(assets/art_jpeg/chapter_20_opener.jpg)
...
```{r, out.width=460}
knitr::include_graphics("assets/art_jpeg/figure_20-02.jpg")
```
...
## Raku jagunemist reguleerivad füsioloogilised signaalid
...
.pull-right[
- Raku vaikeolekuse minek võib olla aktiivselt reguleeritud
